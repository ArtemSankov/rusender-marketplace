          ...
          cachedIsAvailableResponse = (async () => {
            try {
              ...
              if (err.response && err.response.status === 404) {
                ...
                const codes = e2 instanceof Error && e2.name === "AggregateError" ? e2.errors.map((error) => error.code ? error.code.toString() : "UNKNOWN") : [err.code ? err.code.toString() : "UNKNOWN"];
...
var require_oauth2client = __commonJS({
  "node_modules/google-auth-library/build/src/auth/oauth2client.js"(exports) {
    ...
    })(CodeChallengeMethod2 || (exports.CodeChallengeMethod = CodeChallengeMethod2 = {}));
...
var require_src5 = __commonJS({
  "node_modules/gtoken/build/cjs/src/index.cjs"(exports) {
    ...
    var readFile2 = fs2.readFile ? (0, _util.promisify)(fs2.readFile) : /* @__PURE__ */ _asyncToGenerator(/* @__PURE__ */ _regenerator().m(function _callee() {
      ...
      async refreshToken() {
        try {
          ...
          if (error instanceof gaxios_1.GaxiosError) {
            status2 = error?.response?.data?.error?.status;
            message = error?.response?.data?.error?.message;
          }
          if (status2 && message) {
            error.message = `${status2}: unable to impersonate: ${message}`;
            throw error;
          } else {
...
var require_apiIndex = __commonJS({
  "node_modules/googleapis-common/build/src/apiIndex.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_isbrowser = __commonJS({
  "node_modules/googleapis-common/build/src/isbrowser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_util3 = __commonJS({
  "node_modules/googleapis-common/build/src/util.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_http2 = __commonJS({
  "node_modules/googleapis-common/build/src/http2.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        try {
          req = session.request(headers).on("response", (responseHeaders) => {
            ...
            if (responseHeaders[HTTP2_HEADER_CONTENT_ENCODING] === "gzip") {
              stream = req.pipe(zlib2.createGunzip());
            }
            if (opts.responseType === "stream") {
              res.data = stream;
              resolve2(res);
...
var require_package3 = __commonJS({
  "node_modules/googleapis-common/package.json"(exports, module) {
    module.exports = {
...
var require_apirequest = __commonJS({
  "node_modules/googleapis-common/build/src/apirequest.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_authplus = __commonJS({
  "node_modules/googleapis-common/build/src/authplus.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_endpoint = __commonJS({
  "node_modules/googleapis-common/build/src/endpoint.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_discovery = __commonJS({
  "node_modules/googleapis-common/build/src/discovery.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var readFile2 = util.promisify(fs2.readFile);
    var Discovery = class {
          ...
          if (!apisIndex[set.api.name]) {
            ...
            apisIndex[set.api.name] = (options) => {
              ...
              try {
                ...
                throw new Error(util.format('Unable to load endpoint %s("%s"): %s', set.api.name, version, e2.message));
              }
            };
          }
      ...
      async discoverAPI(apiDiscoveryUrl) {
        if (typeof apiDiscoveryUrl === "string") {
          ...
          if (apiDiscoveryUrl && !parts.protocol) {
            ...
            const file = await readFile2(apiDiscoveryUrl, { encoding: "utf8" });
...
var require_src7 = __commonJS({
  "node_modules/googleapis-common/build/src/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m2, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m2, k);
    ...
    exports.googleAuthLibrary = require_src6();
    exports.gaxios = require_src2();
    var google_auth_library_1 = require_src6();
    Object.defineProperty(exports, "OAuth2Client", { enumerable: true, get: function() {
    ...
    Object.defineProperty(exports, "getAPI", { enumerable: true, get: function() {
      return apiIndex_1.getAPI;
    } });
    var apirequest_1 = require_apirequest();
    Object.defineProperty(exports, "createAPIRequest", { enumerable: true, get: function() {
      return apirequest_1.createAPIRequest;
    } });
    var authplus_1 = require_authplus();
    Object.defineProperty(exports, "AuthPlus", { enumerable: true, get: function() {
      return authplus_1.AuthPlus;
    } });
    var discovery_1 = require_discovery();
    Object.defineProperty(exports, "Discovery", { enumerable: true, get: function() {
      return discovery_1.Discovery;
    } });
    var endpoint_1 = require_endpoint();
    Object.defineProperty(exports, "Endpoint", { enumerable: true, get: function() {
...
// node_modules/@googleapis/gmailpostmastertools/build/v1.js
var require_v1 = __commonJS({
  "node_modules/@googleapis/gmailpostmastertools/build/v1.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gmailpostmastertools_v1 = void 0;
    var googleapis_common_1 = require_src7();
    var gmailpostmastertools_v1;
    (function(gmailpostmastertools_v12) {
      ...
      gmailpostmastertools_v12.Gmailpostmastertools = Gmailpostmastertools;
      ...
      gmailpostmastertools_v12.Resource$Domains = Resource$Domains;
      ...
      gmailpostmastertools_v12.Resource$Domains$Trafficstats = Resource$Domains$Trafficstats;
    })(gmailpostmastertools_v1 || (exports.gmailpostmastertools_v1 = gmailpostmastertools_v1 = {}));
  }
});

// node_modules/@googleapis/gmailpostmastertools/build/v1beta1.js
var require_v1beta1 = __commonJS({
  "node_modules/@googleapis/gmailpostmastertools/build/v1beta1.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gmailpostmastertools_v1beta1 = void 0;
    var googleapis_common_1 = require_src7();
    var gmailpostmastertools_v1beta1;
    (function(gmailpostmastertools_v1beta12) {
      class Gmailpostmastertools {
        context;
        domains;
        constructor(options, google) {
      ...
      gmailpostmastertools_v1beta12.Gmailpostmastertools = Gmailpostmastertools;
      class Resource$Domains {
        context;
        trafficStats;
        constructor(context) {
      ...
      gmailpostmastertools_v1beta12.Resource$Domains = Resource$Domains;
      class Resource$Domains$Trafficstats {
        context;
        constructor(context) {
          this.context = context;
      ...
      gmailpostmastertools_v1beta12.Resource$Domains$Trafficstats = Resource$Domains$Trafficstats;
    })(gmailpostmastertools_v1beta1 || (exports.gmailpostmastertools_v1beta1 = gmailpostmastertools_v1beta1 = {}));
  }
});

// node_modules/@googleapis/gmailpostmastertools/build/v2.js
var require_v2 = __commonJS({
  "node_modules/@googleapis/gmailpostmastertools/build/v2.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.gmailpostmastertools_v2 = void 0;
    var googleapis_common_1 = require_src7();
    var gmailpostmastertools_v2;
    (function(gmailpostmastertools_v22) {
      class Gmailpostmastertools {
        context;
        domains;
        domainStats;
      ...
      gmailpostmastertools_v22.Gmailpostmastertools = Gmailpostmastertools;
      class Resource$Domains {
        context;
        domainStats;
        users;
      ...
      gmailpostmastertools_v22.Resource$Domains = Resource$Domains;
      ...
      gmailpostmastertools_v22.Resource$Domains$Domainstats = Resource$Domains$Domainstats;
      ...
      gmailpostmastertools_v22.Resource$Domains$Users = Resource$Domains$Users;
      ...
      gmailpostmastertools_v22.Resource$Domainstats = Resource$Domainstats;
    })(gmailpostmastertools_v2 || (exports.gmailpostmastertools_v2 = gmailpostmastertools_v2 = {}));
  }
});

// node_modules/@googleapis/gmailpostmastertools/build/index.js
var require_build = __commonJS({
  "node_modules/@googleapis/gmailpostmastertools/build/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.gmailpostmastertools = gmailpostmastertools2;
    var googleapis_common_1 = require_src7();
    var v1_1 = require_v1();
    Object.defineProperty(exports, "gmailpostmastertools_v1", { enumerable: true, get: function() {
      return v1_1.gmailpostmastertools_v1;
    } });
    var v1beta1_1 = require_v1beta1();
    Object.defineProperty(exports, "gmailpostmastertools_v1beta1", { enumerable: true, get: function() {
      return v1beta1_1.gmailpostmastertools_v1beta1;
    } });
    var v2_1 = require_v2();
    Object.defineProperty(exports, "gmailpostmastertools_v2", { enumerable: true, get: function() {
      return v2_1.gmailpostmastertools_v2;
    } });
    exports.VERSIONS = {
    ...
    function gmailpostmastertools2(versionOrOptions) {
...
// plugins/rusender-domain-reputation/skills/rusender-domain-reputation/scripts/google_postmaster.ts
var import_gmailpostmastertools = __toESM(require_build(), 1);
...
var SCOPE = "https://www.googleapis.com/auth/postmaster.traffic.readonly";
var SCRIPT_DIRECTORY = dirname(fileURLToPath(import.meta.url));
var SKILL_DIRECTORY = resolve(SCRIPT_DIRECTORY, "..");
...
var DEFAULT_TOKEN = join(dataDirectory(), "google-postmaster-token.json");
var DEFAULT_CLIENT = join(SKILL_DIRECTORY, "config", "google-postmaster-oauth.json");
...
async function loadClientConfig(path) {
...
function normalizeCredentials(data) {
  ...
  return {
    ...
    expiry_date: optionalNumber(data.expiry_date) ?? (legacyExpiry === void 0 ? void 0 : legacyExpiry * 1e3)
  };
}
function credentialJson(credentials) {
  ...
  for (const key of [
    ...
    if (value !== void 0 && value !== null && value !== "") result[key] = value;
  }
  return result;
}
...
function createOAuthClient(config, redirectUri) {
  return new import_gmailpostmastertools.auth.OAuth2({
    clientId: config.clientId,
    clientSecret: config.clientSecret,
    redirectUri
  });
}
async function authorizedClient(config, tokenPath) {
...
function safeError(error) {
  ...
  const status2 = response ? response.status : void 0;
  const responseData = response ? response.data : void 0;
  if (status2 !== void 0 || responseData !== void 0) {
    return JSON.stringify({ http_status: status2, response: responseData });
  }
  return optionalString(error.message) ?? String(error);
}
function callbackPage(ok, locale) {
  const russian = locale.toLowerCase().startsWith("ru");
  const message = russian ? ok ? "Google Postmaster \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0451\u043D. \u041C\u043E\u0436\u043D\u043E \u0432\u0435\u0440\u043D\u0443\u0442\u044C\u0441\u044F \u043A \u043E\u0442\u0447\u0451\u0442\u0443." : "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0438\u0442\u044C Google Postmaster. \u0412\u0435\u0440\u043D\u0438\u0442\u0435\u0441\u044C \u043A \u043E\u0442\u0447\u0451\u0442\u0443 \u0434\u043B\u044F \u043F\u043E\u0434\u0440\u043E\u0431\u043D\u043E\u0441\u0442\u0435\u0439." : ok ? "Google Postmaster is connected. You can return to the report." : "Google Postmaster could not be connected. Return to the report for details.";
...
async function connect(config, tokenPath, timeoutSeconds, locale, noBrowser) {
  const state = randomBytes(24).toString("base64url");
  let settleCallback;
  const callback = new Promise((resolvePromise) => {
...
async function collect(config, tokenPath, domain, days) {
  const { client, credentials } = await authorizedClient(config, tokenPath);
  const api = (0, import_gmailpostmastertools.gmailpostmastertools)({ version: "v2", auth: client });
  ...
  try {
    ...
    evidence.checked_at = (/* @__PURE__ */ new Date()).toISOString();
    evidence.data_available = metrics.length > 0 || evidence.compliance !== null;
    evidence.note = evidence.data_available ? null : "Google returned no data for this period; traffic may be below Postmaster thresholds.";
  } catch (error) {
...
async function status(config, tokenPath) {
  if (!config) {
  ...
  try {
    ...
    if (!credentials.access_token || expiryDate <= Date.now() + 6e4) {
...
@googleapis/gmailpostmastertools/build/index.js:
